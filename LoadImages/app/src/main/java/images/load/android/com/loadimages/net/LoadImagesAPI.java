...
public class LoadImagesAPI {
    ...
    /**
     * Method used to call the service flickr.interestingness.getList
     *
     * @param page
     * @param listener
     * @param errorListener
    ...
    /**
     * Method used to call service flickr.photos.search
     *
     * @param page
     * @param text
     * @param listener
    ...
    /**
     * Obtains the corresponding endpoint for each thumbnail image
     *
     * @param farm
     * @param server
     * @param id
    ...
    /**
     * Obtains the corresponding method for the detailed image
     *
     * @param farm
     * @param server
     * @param id
